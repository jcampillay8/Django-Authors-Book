...
def books(request):
    ...
    return render(request, "books_authors_app/books.html", data)
...
def view_book(request,book_id):
    ...
    return render(request, "books_authors_app/book.html", data)
...
def authors(request):
    ...
    return render(request, "books_authors_app/authors.html", data)
...
def view_author(request,author_id):
    ...
    return render(request, "books_authors_app/author.html", data)
